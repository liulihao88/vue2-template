      ...
      children: [
        ...
        },
        {
          ...
          component:
            () =>
              import(
                '@/views/three/completeThreePage'
              ),
          meta: {
            title:
              'completeThreePage完整页面',
          },
        },
        {
          ...
          component:
            () =>
              import(
                '@/views/three/completeThreePage2'
              ),
          meta: {
            title:
              'completeThreePage2完整页面',
          },
        },
        {
          ...
          component:
            () =>
              import(
                '@/views/three/completeThreePage3'
              ),
          meta: {
            title:
              'completeThreePage3完整页面',
          },
        },
        {
          ...
          component:
            () =>
              import(
                '@/views/three/completeThreePageNew'
              ),
          meta: {
            title:
              'completeThreePageNew新的完整页面',
          },
        },
        {
          ...
          component:
            () =>
              import(
                '@/views/three/testCompleteThreePage'
              ),
          meta: {
            title:
              'testCompleteThreePage测试完整页面',
          },
        },
