<template>
  <div class="box">
    <avue-crud :data="tableData" :option="tableOption" ref="crud" class="custom-dark-crud" @row-save="handleSave" @row-update="handleUpdate" @row-del="handleDelete" :highlight-current-row="false">
